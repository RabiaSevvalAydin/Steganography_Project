...
from tabs.text_hiding_tab import TextHidingTab
from tabs.image_hiding_tab import ImageHidingTab
...
class HidingPage:
    ...
    def create_page(self):
        """Veri gizleme sayfasını oluştur"""
        # Ana frame
        ...
        # Tab'ları oluştur
        self.text_hiding_tab = TextHidingTab(self.notebook)
        self.image_hiding_tab = ImageHidingTab(self.notebook)
